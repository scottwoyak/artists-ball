...
/* harmony import */ var _ModelsDropDownMenu__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./ModelsDropDownMenu */ "./src/ModelsDropDownMenu.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
var PlanesApp = /** @class */ (function () {
    ...
    PlanesApp.prototype.createViewElements = function (parent) {
        ...
        Object(_ModelsDropDownMenu__WEBPACK_IMPORTED_MODULE_13__["createModelsDropDownMenu"])(parent, function (file) { return _this.loadModel(file); });
    };
...
var PlanesRenderer = /** @class */ (function () {
    ...
    PlanesRenderer.prototype.getViewSize = function () {
        var gl = this.gl;
    ...
    PlanesRenderer.prototype.resize = function () {
        ...
        this.projection = _glMat__WEBPACK_IMPORTED_MODULE_0__["glMat4"].makeOrtho(viewSize.minX, viewSize.maxX, viewSize.minY, viewSize.maxY, viewSize.minZ, viewSize.maxZ);
    ...
    PlanesRenderer.prototype.renderToScreen = function () {
        ...
        if (this.showShadowMap) {
            ...
            if (this.showMiniView) {
                ...
                var viewSize = this.getViewSize();
                this.view.translate(new _glVec__WEBPACK_IMPORTED_MODULE_1__["glVec3"]([viewSize.maxX - this.miniSize, viewSize.maxY - this.miniSize, 0]));
                uni.set('view', this.view.transpose());
    ...
    PlanesRenderer.prototype.drawBall = function () {
        ...
        this.view.scale(this.miniSize);
        var viewSize = this.getViewSize();
        this.view.translate(new _glVec__WEBPACK_IMPORTED_MODULE_1__["glVec3"]([viewSize.minX + this.miniSize, viewSize.maxY - this.miniSize, 0]));
        uni.set('view', this.view.transpose());
        uni.set('uUseThresholds', this.uUseThresholds ? 1 : 0, true);
...
/* harmony import */ var worker_loader_name_LoaderWorker_worker_js_LoaderWorker__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! worker-loader?name=LoaderWorker.worker.js!./LoaderWorker */ "./node_modules/worker-loader/dist/cjs.js?name=LoaderWorker.worker.js!./src/LoaderWorker.ts");
/* harmony import */ var worker_loader_name_LoaderWorker_worker_js_LoaderWorker__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(worker_loader_name_LoaderWorker_worker_js_LoaderWorker__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _ModelsDropDownMenu__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ModelsDropDownMenu */ "./src/ModelsDropDownMenu.ts");
...
var ViewerApp = /** @class */ (function () {
    ...
    ViewerApp.prototype.createViewElements = function (parent) {
        ...
        Object(_ModelsDropDownMenu__WEBPACK_IMPORTED_MODULE_9__["createModelsDropDownMenu"])(parent, function (file) { return _this.loadModel(file); });
    ...
    ViewerApp.prototype.loadModelFile = function (file) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            // if a previous worker exists, close it
            if (_this.worker) {
            ...
            _this.worker = new worker_loader_name_LoaderWorker_worker_js_LoaderWorker__WEBPACK_IMPORTED_MODULE_8___default.a();
            var tStart = Date.now();
            _this.worker.onmessage = function (_a) {
                var data = _a.data;
                if (typeof data === 'string') {
                    ...
                    var tObj = _TriangleObj__WEBPACK_IMPORTED_MODULE_5__["TriangleObj"].fromData(data);
                    _this.overlay.innerText = '';
                    _this.worker.terminate();
                    _this.worker = undefined;
                    resolve(tObj);
    ...
    ViewerApp.prototype.orient = function (tObj, query) {
        // orient each file so that it is facing forward
        var file = query.toLowerCase();
        file = file.split('.')[0];
        switch (file) {
            case 'skull1':
                this.renderer.rotX(Object(_Globals__WEBPACK_IMPORTED_MODULE_1__["toRad"])(90));
                this.renderer.rotY(Object(_Globals__WEBPACK_IMPORTED_MODULE_1__["toRad"])(180));
                break;
            case 'pelvis':
                this.renderer.rotX(Object(_Globals__WEBPACK_IMPORTED_MODULE_1__["toRad"])(11));
                this.renderer.rotZ(Object(_Globals__WEBPACK_IMPORTED_MODULE_1__["toRad"])(-87));
                break;
            case 'wolf':
                this.renderer.rotY(Object(_Globals__WEBPACK_IMPORTED_MODULE_1__["toRad"])(-140));
                this.renderer.rotX(Object(_Globals__WEBPACK_IMPORTED_MODULE_1__["toRad"])(5));
                break;
            case 'sheephead':
                this.renderer.rotY(Object(_Globals__WEBPACK_IMPORTED_MODULE_1__["toRad"])(-160));
                break;
            case 'pose1':
                break;
            case 'teapot':
                this.renderer.rotY(Object(_Globals__WEBPACK_IMPORTED_MODULE_1__["toRad"])(90));
                break;
            default:
                this.renderer.rotY(Object(_Globals__WEBPACK_IMPORTED_MODULE_1__["toRad"])(180));
                break;
