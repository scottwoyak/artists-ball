...
var BlobBreaker = /** @class */ (function () {
    ...
    BlobBreaker.prototype.next = function (len) {
        var _a;
        // oh, Apple
        var slice = (_a = this.blob.webkitSlice) !== null && _a !== void 0 ? _a : this.blob.slice;
        var b = slice(this.start, this.start + len);
        this.start += len;
        return b;
    };
