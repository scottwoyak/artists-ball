...
var PlanesApp = /** @class */ (function () {
    ...
    PlanesApp.prototype.createViewElements = function (parent) {
        ...
        menu.addItem('Skull 1', function () { return _this.loadModel('Skull1.obj'); });
        //menu.addItem('Skull 2', () => this.loadModel('Skull2.obj'));
        menu.addItem('Skull 3', function () { return _this.loadModel('Skull3.obj'); });
        //menu.addItem('Head Ecorche', () => this.loadModel('HeadEcorche.obj'));
        menu.addItem('Pelvis', function () { return _this.loadModel('Pelvis.obj'); });
    ...
    PlanesApp.prototype.loadModel = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var radius, center, tObj, size, center, tObj, tObj;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(query && query.toLowerCase() === 'trianglesphere')) return [3 /*break*/, 1];
                        radius = 0.75;
                        center = new _glVec__WEBPACK_IMPORTED_MODULE_5__["glVec3"]([0, 0, 0]);
                        tObj = new _TriangleSphere__WEBPACK_IMPORTED_MODULE_7__["TriangleSphere"](100, radius, center);
                        tObj.computeNormals(_TriangleObj__WEBPACK_IMPORTED_MODULE_6__["NormalType"].Smooth);
                        this.renderer.setModel(tObj);
                        return [2 /*return*/, Promise.resolve(tObj)];
                    case 1:
                        if (!(query && query.toLowerCase() === 'trianglecube')) return [3 /*break*/, 2];
                        size = 0.8;
                        center = new _glVec__WEBPACK_IMPORTED_MODULE_5__["glVec3"]([0, 0, 0]);
                        tObj = new _TriangleCube__WEBPACK_IMPORTED_MODULE_8__["TriangleCube"](size, center);
                        this.renderer.setModel(tObj);
                        return [2 /*return*/, Promise.resolve(tObj)];
                    case 2:
                        if (!(query && query.toLowerCase().endsWith('.obj'))) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.loadModelFile(query)];
                    case 3:
                        tObj = _a.sent();
    ...
    PlanesApp.prototype.loadModelFile = function (file) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.worker = new worker_loader_name_LoaderWorker_worker_js_LoaderWorker__WEBPACK_IMPORTED_MODULE_11___default.a();
            var tStart = Date.now();
