...
export class TriangleCube extends TriangleObj {
   ...
   public constructor(size: number, center: Vec3) {
   ...
   createTriangles(size: number, center: Vec3) {

      this.vertices.push(new Vec3([center.x - size / 2, center.y - size / 2, center.z - size / 2]));
      this.vertices.push(new Vec3([center.x - size / 2, center.y - size / 2, center.z + size / 2]));
      this.vertices.push(new Vec3([center.x - size / 2, center.y + size / 2, center.z - size / 2]));
      this.vertices.push(new Vec3([center.x - size / 2, center.y + size / 2, center.z + size / 2]));
      this.vertices.push(new Vec3([center.x + size / 2, center.y - size / 2, center.z - size / 2]));
